...
# -*- coding: utf-8 -*-
#
# passkey documentation build configuration file, created by  # noqa: E501
...
modindex_common_prefix = ["passkey"]
...
basename = "passkey".replace(" ", "").replace(".", "")
